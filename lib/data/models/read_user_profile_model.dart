import 'package:craftybay/data/models/user_profile_data.dart';

class ReadUserProfileModel {
  String? msg;
  UserProfileData? data;

  ReadUserProfileModel({this.msg, this.data});

  ReadUserProfileModel.fromJson(Map<String, dynamic> json) {
    msg = json['msg'];
